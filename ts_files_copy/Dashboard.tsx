...
export function Dashboard({ onCreateDiscussion, onViewDiscussion, onViewFriends }: DashboardProps) {
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Public Discussions</p>
                <p className="text-2xl font-bold text-gray-900">{stats.publicDiscussions}</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <button
            ...
            className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-xl shadow-sm hover:from-blue-600 hover:to-blue-700 transition-all transform hover:scale-105"
          >
            <div className="flex items-center">
              <Plus className="w-8 h-8 mr-4" />
              <div className="text-left">
                <h3 className="text-lg font-semibold">Create Discussion</h3>
                <p className="text-blue-100">Start a new argument visualization</p>
              </div>
            </div>
          </button>
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-xl shadow-sm hover:from-purple-600 hover:to-purple-700 transition-all transform hover:scale-105"
          >
            <div className="flex items-center">
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-xl shadow-sm">
            <div className="flex items-center">
              ...
              <div className="text-left">
                ...
                <p className="text-green-100">Explore trending discussions</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => {/* Navigate to discussions view */}}
